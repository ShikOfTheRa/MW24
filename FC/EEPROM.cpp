...
void LoadDefaults() {
  uint8_t i;
  ...
  #else
	  #if PID_CONTROLLER == 1
      conf.pid[ROLL].P8     = 33;  conf.pid[ROLL].I8    = 15; conf.pid[ROLL].D8     = 23;
      conf.pid[PITCH].P8    = 33; conf.pid[PITCH].I8    = 15; conf.pid[PITCH].D8    = 23;
      conf.pid[PIDLEVEL].P8 = 50; conf.pid[PIDLEVEL].I8 = 10; conf.pid[PIDLEVEL].D8 = 100;
    ...
    #endif
    conf.pid[YAW].P8      = 38;  conf.pid[YAW].I8     = 15;  conf.pid[YAW].D8     = 0;
    conf.pid[PIDALT].P8   = 54; conf.pid[PIDALT].I8   = 25; conf.pid[PIDALT].D8   = 24;
