 ...
 */
  ...
  /**************************************************************************************/
   ...
   /* GPS protocol 
    ...
    #define MAG_DECLINATION  10.0f   //(**)

    #define GPS_LEAD_FILTER                      // Adds a forward predictive filterig to compensate gps lag. Code based on Jason Short's lead filter implementation
    
    //#define GPS_FILTERING                        // add a 5 element moving average filter to GPS coordinates, helps eliminate gps noise but adds latency comment out to disable
    #define GPS_WP_RADIUS              400       // if we are within this distance to a waypoint then we consider it reached (distance is in cm)
  ...
  /**************************************************************************************/
    ...
    #define LCD_TELEMETRY_STEP "792345" // should contain a 0 to allow switching off.

    /* optional exclude some functionality - uncomment to suppress some unwanted telemetry pages */
    //#define SUPPRESS_TELEMETRY_PAGE_1 // Battery voltage, actual current (Amperes), max. current (Amperes), flight time, height, active checkboxes
    //#define SUPPRESS_TELEMETRY_PAGE_2 // gyro&acc values
    //#define SUPPRESS_TELEMETRY_PAGE_3 // checkboxes and modes
    //#define SUPPRESS_TELEMETRY_PAGE_4 // RX input values
    //#define SUPPRESS_TELEMETRY_PAGE_5 // outputs - motor and servo values
    //#define SUPPRESS_TELEMETRY_PAGE_6 // not used
    //#define SUPPRESS_TELEMETRY_PAGE_7 // GPS coordinates and status info
    //#define SUPPRESS_TELEMETRY_PAGE_8 // not used
    //#define SUPPRESS_TELEMETRY_PAGE_9 // diagnostics: number of failsafe events, i2c errors, annex overruns, cycle times, debug[] values
  ...
  /********************************************************************/
     ...
     */
    #define BOARD_NAME "PARIS-MEGA-V-.--"
    //                  123456789.123456
